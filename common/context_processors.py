...
leftMenuBtnsCommon = (
    {'name':'SQL审核', 'url':'', 'class':'glyphicon glyphicon-tint',
     'submenus':(
        {'name': '查看审核工单', 'url': '/sqlreview/allworkflow/', 'class': 'glyphicon glyphicon-home'},
    ...
    {'name': 'SQL查询', 'url': '', 'class': 'glyphicon glyphicon-search',
     'submenus': (
         {'name': '查看查询工单', 'url': '/sqlquery/allworkflow/', 'class': 'glyphicon glyphicon-home'},
         {'name': '发起SQL查询', 'url': '/sqlquery/submitsql/', 'class': 'glyphicon glyphicon-asterisk'},
         # {'name': 'SQL审核必读', 'url': '/dbaprinciples/', 'class': 'glyphicon glyphicon-book'},
         # {'name': '统计图表展示', 'url': '/charts/', 'class': 'glyphicon glyphicon-file'},
     )},
    {'name': '其他', 'url': '', 'class': 'glyphicon glyphicon-th-list',
     'submenus': (
